...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentElementHTML('afterbegin', markup);
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmVtYXV4IiwiYSI6ImNsejg4c2Y3aDAwZTAybHNodzJzdmk0dHMifQ.EYtILTrsq1d2YS56i4ZJCQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/remaux/clz88zcj8001b01qrf12z6th0',
    scrollZoom: false,
    e: e
  });
